...
<div className='body'>
    <div  className="md:flex-auto home_pg flex-wrap">
        {posts && posts.map((post, i) => {
            return (
                <div key={i} className="mb-4 w-1/3 h-2/3" onClick={() => navigate(`/post/${post._id}`)}>
                    <div className="bck-clr max-w-sm rounded overflow-hidden shadow-lg text-red-800">
                        ...
                        <div>
                            <button className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Request</button>
                        </div>
                    </div>
